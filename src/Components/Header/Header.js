   ...
   return (
      <header className="header container">
         <div className="header-logo">
            <Link to="/">
               <svg aria-label="Instagram" className="header-svg _ab6-" color="#262626" fill="#262626" height="29" role="img" viewBox="32 4 113 32" width="103">
                  <path
                     clipRule="evenodd"
